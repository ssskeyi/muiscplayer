class MusicPlayer {
  constructor() {
    ...
    this.currentCollectionDisplay =
      document.getElementById("current-collection");
...
function searchSongs(query) {
  ...
  const allSongs = document.querySelectorAll("#songs-list li");
